...
@Component({
  selector: 'app-sociallinkss',
  templateUrl: './sociallinkss.component.html',
  styleUrls: ['./sociallinkss.component.css']
})
export class SociallinkssComponent implements OnInit {
