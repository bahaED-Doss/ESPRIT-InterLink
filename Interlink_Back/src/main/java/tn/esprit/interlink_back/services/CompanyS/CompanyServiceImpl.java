package tn.esprit.interlink_back.services.CompanyS;
...
public class CompanyServiceImpl implements ICompanyService {
    ...
    public CompanyServiceImpl(CompanyRepository companyRepository, GeocodingService geocodingService ,  UserService userService) {
 ...
 @Override
 public Company addCompanyWithHR(Company company, Long hrId) {
    // Convert Long to int for getUserById
    User hr = userService.getUserById(hrId.intValue());
    if (hr == null) {
    ...
    company.getEmployees().add(hr);
    hr.setCompany(company);
    
    geocodingService.geocodeCompanyLocation(company);
    enrichCompanyInfo(company);
    return companyRepository.save(company);
}

 @Override
 public Optional<Company> findByEmployeesId(Long hrId) {
     return companyRepository.findByEmployeesId(hrId);
 }

 @Override
 public Optional<Company> findByEmployeesEmail(String email) {
     return companyRepository.findByEmployeesEmail(email);
 }
